<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','fileName','filePath',]" />
            <wj-flex-grid-cell-template cellType="RowHeader" v-slot="cell">{{cell.row.index + 1}}</wj-flex-grid-cell-template>
            <wj-flex-grid-column binding="fileName" header="파일 이름" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="filePath" header="파일 경로" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <v-col>
            <v-dialog
                v-model="openDialog"
                ...
                <template>
                    <v-card>
                        <v-toolbar
                            ...
                            height="50px"
                        >
                            <div style="color:white; font-size:17px; font-weight:700;">인덱스 등록</div>
                            <v-spacer></v-spacer>
                            <v-icon
                                color="white"
                                small
